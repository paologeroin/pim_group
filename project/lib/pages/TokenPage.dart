...
class TokenPage extends StatelessWidget {
  ...
  static const routeDisplayName = 'TokenPage';

  @override
  Widget build(BuildContext context) {
    print('${TokenPage.routeDisplayName} built');

    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 109, 230, 69),
        centerTitle: true,
        title: Text(TokenPage.routeDisplayName),
      ),
      body: Center(
        child: Column(
          ...
          children: [
            ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      Color.fromARGB(255, 109, 230, 69), // Background color
                ),
                onPressed: () async {
  ...
  // METHODS FOR ISIMPACT, GET AND STORE OR REFRESH TOKENS
